...
var InView = class extends React4.Component {
  ...
  render() {
    ...
    return React4.createElement(as || "div", _extends2({
      ref: this.handleNode
    }, props), children);
  }
};
function useInView({
  ...
  const previousEntryTarget = React4.useRef();
...
var Reveal = (props) => {
  ...
  const animationStyles = (0, import_react18.useMemo)(
    () => getAnimationCss({
  ...
  return jsx2(Fragment4, { children: import_react18.Children.map(children, (node2, index) => {
    if (!(0, import_react18.isValidElement)(node2))
      return null;
...
var AttentionSeeker = (props) => {
  ...
  const [keyframes87, animationCss3] = (0, import_react3.useMemo)(() => getStyles(effect), [effect]);
  return jsx2(
    Reveal,
    {
      keyframes: keyframes87,
...
var Bounce = (props) => {
  ...
  const keyframes87 = (0, import_react33.useMemo)(
    () => getStyles2(reverse, direction),
    [direction, reverse]
  );
  return jsx2(Reveal, { keyframes: keyframes87, ...rest });
};
...
var Fade = (props) => {
  ...
  const keyframes87 = (0, import_react44.useMemo)(
...
var Flip = (props) => {
  ...
  const keyframes87 = (0, import_react58.useMemo)(
...
var Roll = (props) => {
  ...
  const keyframes87 = (0, import_react68.useMemo)(() => getStyles5(reverse), [reverse]);
  return jsx2(Reveal, { keyframes: keyframes87, ...rest });
};
...
var Rotate = (props) => {
  const { direction, reverse = false, style, ...rest } = props;
  const [keyframes87, animationCss3] = (0, import_react69.useMemo)(
...
var Slide = (props) => {
  const { direction, reverse = false, ...rest } = props;
  const keyframes87 = (0, import_react80.useMemo)(
...
var Zoom = (props) => {
  const { direction, reverse = false, ...rest } = props;
  const keyframes87 = (0, import_react89.useMemo)(
