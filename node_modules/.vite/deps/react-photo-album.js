...
function srcSetAndSizes(photo, layout, layoutOptions) {
  ...
  if (photo.images && photo.images.length > 0) {
    srcSet = photo.images.concat(!photo.images.find(({ width }) => width === photo.width) ? [{ src: photo.src, width: photo.width, height: photo.height }] : []).sort((first, second) => first.width - second.width).map((image) => `${image.src} ${image.width}w`).join(", ");
...
function PhotoRenderer(props) {
  ...
  const renderDefaultPhoto = (options) => {
    ...
    return React.createElement("img", { alt, ...srcSet ? { srcSet, sizes } : null, src, style: (options === null || options === void 0 ? void 0 : options.wrapped) ? { display: "block", width: "100%", height: "100%" } : unwrappedStyle, ...rest });
  };
...
function RowsLayout(props) {
  ...
  if (!rowsLayout)
    return null;
  return React.createElement(React.Fragment, null, rowsLayout.map((row, rowIndex) => React.createElement(RowContainerRenderer, { key: `row-${rowIndex}`, layoutOptions, rowIndex, rowsCount: rowsLayout.length, renderRowContainer, rowContainerProps: componentsProps === null || componentsProps === void 0 ? void 0 : componentsProps.rowContainerProps }, row.map(({ photo, layout }) => React.createElement(PhotoRenderer, { key: photo.key || photo.src, photo, layout, layoutOptions, renderPhoto, imageProps: componentsProps === null || componentsProps === void 0 ? void 0 : componentsProps.imageProps })))));
}
...
function ColumnsLayout(props) {
  ...
  return React.createElement(React.Fragment, null, columnsModel.map((column, columnIndex) => React.createElement(ColumnContainerRenderer, { key: `column-${columnIndex}`, layoutOptions, columnIndex, columnsCount: columnsModel.length, columnsGaps, columnsRatios, renderColumnContainer, columnContainerProps: componentsProps === null || componentsProps === void 0 ? void 0 : componentsProps.columnContainerProps }, column.map(({ photo, layout }) => React.createElement(PhotoRenderer, { key: photo.key || photo.src, photo, layout, layoutOptions, renderPhoto, imageProps: componentsProps === null || componentsProps === void 0 ? void 0 : componentsProps.imageProps })))));
}
...
function MasonryLayout(props) {
  ...
  if (!masonryLayout)
    return null;
  return React.createElement(React.Fragment, null, masonryLayout.map((column, columnIndex) => React.createElement(ColumnContainerRenderer, { key: `masonry-column-${columnIndex}`, layoutOptions, columnsCount: masonryLayout.length, columnIndex, renderColumnContainer, columnContainerProps: componentsProps === null || componentsProps === void 0 ? void 0 : componentsProps.columnContainerProps }, column.map(({ photo, layout }) => React.createElement(PhotoRenderer, { key: photo.key || photo.src, photo, layout, layoutOptions, renderPhoto, imageProps: componentsProps === null || componentsProps === void 0 ? void 0 : componentsProps.imageProps })))));
}
...
function renderLayout(props, containerWidth, componentsProps) {
  ...
  if (layout === "rows") {
    return React.createElement(RowsLayout, { layoutOptions, renderRowContainer, ...commonLayoutProps });
  }
  if (layout === "columns") {
    return React.createElement(ColumnsLayout, { layoutOptions, renderColumnContainer, ...commonLayoutProps });
  }
  return React.createElement(MasonryLayout, { layoutOptions, renderColumnContainer, ...commonLayoutProps });
}
function PhotoAlbum(props) {
  ...
  return React.createElement(ContainerRenderer, { layout, containerRef, renderContainer, containerProps: componentsProps === null || componentsProps === void 0 ? void 0 : componentsProps.containerProps }, containerWidth ? renderLayout(props, containerWidth, componentsProps) : null);
}
export {
  PhotoAlbum,
